...
Los fosfolipidos son derivados del acido fosfatidico, un triglicerido modificado que contiene un grupo fosfato en la tercera posicion.

Las cabezas polares miran hacia fuera, hacia los liquidos acuosos externos y citoplasmaticos, mientras que las colas de acidos grasos de localizacion central participan en interacciones hidrofobas en el centro de la membrana. La barrera formada por esta bicapa lipidica solo puede ser atravesada por moleculas liposolubles muy pequenas (como oxigeno, dioxido de carbono o nitrogeno) y en un grado limitado por particulas polares pequenas sin carga, como el agua y la urea.

Todos los organismos sintetizan cantidades pequenas de lipidos complejos con funciones especializadas y criticas. Muchos de estos lipidos no contienen glicerol y estan formados por unidades de acetil CoA (acetilcoenzima A) de dos atomos de carbono.

 => Esfingolipidos: son eteres lipidicos unidos a una base de esfingosina en lugar de a glicerol

 => Isoprenoides: derivados activados del isopreno, son lipidos formados por una o mas unidades de cinco atomos de carbono, conteniendo enlaces sencillos y dobles alternantes (conjugados) que pueden inactivar radicales libres al aceptar o donar electrones.

 => Terpeno: es un termino generico para todos los compuestos sintetizados a partir de los precursores del isopreno e incluye aceites esenciales de las plantas (e.g limoneno de los limones).

 => Esteroides: son una clase de lipidos derivados de un anillo saturado de cuatro miembros. El colesterol es la base de todos los derivados esteroideos sintetizados en el cuerpo, incluyendo  los glucocorticoesteroides (cortisona) y los mineralcorticoesteroides (aldosterona), los androgenos (testosterona) y los estrogenos (estradiol). La hormona vitamina D se sintetiza cuando los rayos ultravioletas del sol escinden el colesterol en la grasa subcutanea para formar colecalciferol (D3). La vitamina D sintetica se sintetiza irradiando el esteroide vegetal ergoesterol para formar ergocalciferol (D2).

 => Glucolipidos: incluyen los cerebrosidos y los gangliosidos, que estan formados por una base de esfingosina y acidos largos de cadena muy larga (22C). Ambos participan en el transporte lipidico.

****** Lipidos sinteticos

Se encuentran de forma natural en la nata, aceite de coco y el aceite de semilla de palma, pero tambien se producen como subproducto de la elaboracion de la margarina.

Los trigliceridos de cadena media (TCM) son AGS con una longitud de cadena de entre 6 y 12 atomos de carbono. Aportan 8.25 kcal/g, son suficientemente cortos para ser hidrosolubles, necesitan menos sales biliares para su solubilizacion, no son reeterificados en el enterocito y son transportados como acidos grasos libres.

Los lipidos estructurados incluyen aceite de TCM esterificado con un acido graso como acido linolenico o un lipido omega-3. Se absorben mas rapidamente que el triglicerido de cadena larga solo.

Los sustitutos de la grasa son diferente estructuralmente a las grasas y no aportan nutrientes facilmente absorbibles, pero imitan la textura y otras sensaciones de la grasa en la boca. El valor calorico varia entre 5 kcal/g (por ej. caprenina) y 0 kcal/g (por ej. olestra, carragenano).

Sustitutos de la grasa
|--------------------------+-----------------------------------------------------------|
| Basados en carbohidratos | Polidextrosa                                              |
|                          | Almidon alimenticio modificado                            |
|                          | Maltodextrinas                                            |
|                          | Basados en grano (fibra)                                  |
|                          | Dextrinas                                                 |
|                          | Gomas (xantano, guar, algarrobo, carragenano, alginatos)  |
|                          | Pectinas                                                  |
|                          | Celulosa (carboximetilcelulosa, celulosa microcristalina) |
|                          | Basados en fruta (fibra)                                  |
|--------------------------+-----------------------------------------------------------|
| Basados en proteinas     |                                                           |
|--------------------------+-----------------------------------------------------------|
| Basados en grasa         |                                                           |
|--------------------------+-----------------------------------------------------------|
| Combinaciones            |                                                           |
...
Las aplicaciones generalmente son en: lacteos, salsas, postres, productos horneados, rellenos y glaseados, pates, dulces, chocolates, bolleria, etc.

Las propiedades funcionales son: retencion de humedad o agua, formacion de volumen, texturizador, gelificante, espesante, estabilizante, mejora de textura en la boca, etc.

La cantidad de ingesta dietetica de colesterol debe ser menor de 300 mg/dia, reduciendo al maximo ingesta de grasas trans, asi como mantener una cantidad de ingesta total de grasas entre el 20% y el 35% de calorias totales, y la mayoria de ellas debe proceder de AGPI y AGMI.

****** Alcohol (alcohol etilico)

Cantidades moderadas de alcohol etilico tienen efectos positivos sobre enfermedades (como las cardiovasculares), pero sigue siendo una sustancia toxica que contiene 7kcal/g y ningun otro nutriente. Puede atravesar todas las membranas y se absorbe rapidamente.

***** Aminoacidos y proteinas

La estructura de las plantas esta formada principalmente por carbohidratos, mientras que la estructura corporal humana de los animales y humanos se basa en proteinas.

Las moleculas difieren molecularmente de los carbohidratos y de los lipidos en que contienen nitrogeno.

Las principales funciones de las proteinas en el cuerpo incluyen su papel como proteinas estructurales, enzimas, hormonas, proteinas de transporte e inmunoproteinas.

Las proteinas estan basadas por aminoacidos unidos entre si por enlaces peptidicos. La secuencia de los aminoacidos determina la estructura y la funcion ultimas de la proteina y esta determinada por el codigo genetico almacenado en el nucleo celular en forma de ADN.

La sintesis proteica es transportada hasta el reticulo endoplasmatico rugoso a traves del ARNm (ARN mensajero). Se sintetizan nuevas proteinas uniendo aminoacidos como senala el ARNm en una secuencia lineal precisa. Cuando se ha sintetizado la proteina, se desprende del ARNm y esta lista para ser utilizada o para el procesado posterior para su uso.

El plegado adecuado de la cadena lineal completa de aminoacidos es esencial para que la proteina realice sus funciones propias. El plegado se realiza mediante enlaces de hidrogeno, enlaces ionicos e interacciones hidrofobas y de otro tipo entre los grupos R individuales de cada aminoacido. Esto permite que la proteina forme una estructura tridimensional precisa. Existen 4 niveles:

  ==> Estructura primaria: se forman enlaces peptidicos entre aminoacidos secuenciales de acuerdo con las indicaciones del ARNm. La proteina es una cadena lineal de aminoacidos.

  ==> Estructura secundaria: las fuerzas de atraccion entre los grupos R de los aminoacidos crean helices y estructuras de lamina plegada.

  ==> Estructura terciaria: las helices y las laminas plegadas se pliegan en dominios compactos. Las proteinas pequenas tienen un dominio, las proteinas grandes tienen multiples dominios.

  ==> Estructura cuaternaria: los polipeptidos individuales pueden actuar como subunidades en la formacion de montajes mas grandes y complejos. Las subunidades estan unidas entre si por numerosas interacciones debiles no cobalentes, a veces estan estabilizadas por puentes disulfuro.

Todos los aminoacidos tienen la misma estructura general:


  O     NH₂
   \\   |
    C - Cα - R (en el cual R es diferente para cada uno de ellos)
   /    |
  CH    H

****** Aminoacios esenciales

La sintesis proteica precisa la presencia de todos los aminoacidos necesarios durante el proceso. Quimicamente los aminoacidos son acidos carboxilicos con un grupo amino unido al carbono α.

El carbono α es un carbono quiral, y que se pueden formar isomeros. El isomero funcional en el cuerpo humano es el isomero L.

Aminoacidos esenciales
|----------------+-------------------------+-------------------------------------------------------------------------------------------------------------------|
| Tipo funcional | Aminoacido              | Caracteristicas del aminoacido                                                                                    |
|----------------+-------------------------+-------------------------------------------------------------------------------------------------------------------|
| Alifaticos     | Glicina (Gly) G         | Pequeno grupo R (H) que permite curvas en horquilla en las cadenas peptidicas                                     |
|----------------+-------------------------+-------------------------------------------------------------------------------------------------------------------|
|                | Alanina (Ala) A         | Se puede desaminar a piruvato y se puede utilizar para la sintesis de glucosa                                     |
|----------------+-------------------------+-------------------------------------------------------------------------------------------------------------------|
|                | Valina (Val) V*         | Aminoacido de cadena ramificada, se metaboliza en el musculo                                                      |
|----------------+-------------------------+-------------------------------------------------------------------------------------------------------------------|
|                | Leucina (Leu) L*        | Aminoacido de cadena ramificada mas hidrofobo, metabolismo muscular                                               |
|----------------+-------------------------+-------------------------------------------------------------------------------------------------------------------|
|                | Isoleucina (Ile) I*     | El aminoacido de cadena ramificada mas hidrofobo, metabolismo muscular                                            |
|----------------+-------------------------+-------------------------------------------------------------------------------------------------------------------|
| Azufrados      | Cisteina (Cys) C**      | Esencial para la sintesis de glutation, sintesis reducida de enfermedades cronicas                                |
|----------------+-------------------------+-------------------------------------------------------------------------------------------------------------------|
|                | Metionina (Met) M*      | Se convierte en S-adenosilmetionina (SAM), el donante universal de grupos metilo y cisteina                       |
|----------------+-------------------------+-------------------------------------------------------------------------------------------------------------------|
| Hidroxilicos   | Serina (Ser) S          | Grupo hidroxilo fosforilado para activar e inactivar proteinas                                                    |
|----------------+-------------------------+-------------------------------------------------------------------------------------------------------------------|
|                | Treonina (Thr) T        | Tambien es un punto para la fosforilacion reguladora                                                              |
|----------------+-------------------------+-------------------------------------------------------------------------------------------------------------------|
| Aromaticos     | Fenilalanina (Phe) F*   | Se convierte en tirosina para la sintesis de noradrenalina, adrenalina y dopamina                                 |
|----------------+-------------------------+-------------------------------------------------------------------------------------------------------------------|
|                | Tirosina (Tyr) Y        | Se convierte en los neurotransmisores noradrenalina, adrenalina y dopamina                                        |
|----------------+-------------------------+-------------------------------------------------------------------------------------------------------------------|
|                | Triptofano (Trp) W*     | Se convierte en el neurotransmisor serotonina y en niacina                                                        |
|----------------+-------------------------+-------------------------------------------------------------------------------------------------------------------|
| Ciclicos       | Prolina (Pro) P*        | Permite una triple helice< la prolina del colageno se hidroxila para formar enlaces cruzados                      |
|----------------+-------------------------+-------------------------------------------------------------------------------------------------------------------|
| Basicos        | Lisina (Lys) K          | Punto para la ihdroxilacion de proteinas; hidrofobo; se utiliza para transduccion de senales                      |
|----------------+-------------------------+-------------------------------------------------------------------------------------------------------------------|
|                | Histidina (His) H**     | Hidrofilo, se une al cinc en proteinas de transduccion de senales                                                 |
|----------------+-------------------------+-------------------------------------------------------------------------------------------------------------------|
|                | Arginina (Arg) R        | Se forma en el ciclo de la urea< esencial para la sintesis de la via de transduccion de senales del oxido nitrico |
|----------------+-------------------------+-------------------------------------------------------------------------------------------------------------------|
| Acidicos       | Acido aspartico (Asp) D | Acepta un segundo nitrogeno para formar asparaginasa (Asn)                                                        |
|----------------+-------------------------+-------------------------------------------------------------------------------------------------------------------|
|                | Acido glutamico (Glu) E | Acepta un segundo nitrogeno para formar glutamina (Gln)                                                           |
|----------------+-------------------------+-------------------------------------------------------------------------------------------------------------------|

  *  Aminoacidos esenciales
  ** Aminoacidos esenciales para lactantes o enfermedades cronicas
...
Muchos aminoacidos se pueden sintetizar a partir de esqueletos de carbono sintetizados como productos intermediarios en las principales vias metabolicas mediante un proceso denominado trasaminacion, que anade un grupo amino de otro aminoacido sin producir realmente un grupo amino libre. La transaminacion permite la sintesis de aminoacidos no esenciales a partir de productos intermediarios metabolicos a la vez que se utilizan grupos amino libres, de modo que no quedan para producir amoniaco toxico.

Los aminoacidos esenciales tienen esqueletos de carbono que no pueden sintetizar los seres humanos (o en cantidad suficiente) y solo se pueden obtener mediante la dieta.

Las proteinas pueden ser una fuente de energia, conteniendo mas de 5 kcal/g. Sin embargo este proceso elimina el grupo amino y la formacion y excrecion de la urea en un proceso que supone una desaminacion, conteniendo un coste metabolico de mas de 1 kcal/g. En estado de inanicion, las proteinas son la unica fuente disponible para la sintesis de novo de glucosa denominado gluconeogenia. El oxalacetato sale de las mitocondrias y se convierte en FEP (fosfoenolpiruvato). A partir del PEP se puede invertir la via glucolitica porque todas las enzimas, a excepcion de la fosfofructocinasa y la glucocinasa, son reversibles. Estas dos enzimas pueden ser revertidas por enzimas fosfatasas especificas cuando es necesario tener glucosa sanguinea.

Los aminoacidos que producen esqueletos de carbono que se pueden convertir en glucosa se denominan aminoacidos glucogenicos. Todos los aminoacidos esenciales pueden generar glucosa a excepcion de la lisina y treonina, que dan lugar a cetonas y se utilizan para obtener energia, por lo que se conocen como aminoacidos cetogenicos.

Un ser humano adulto y sano necesita 0.8 g de proteina por cada kg de peso corporal.

Estimaciones de las necesidades de los aminoacidos
|-----------------------+----------------------------------|
| Aminoacido            | Necesidades mg/kg/dia en adultos |
|-----------------------+----------------------------------|
| Histidina             |                             8-12 |
|-----------------------+----------------------------------|
| Isoleucina            |                               10 |
...
El valor biologico de una proteina se puede determinar comparando su perfil de aminoacidos esenciales con las necesidades humanas. El aminoacido esencial que aparece con menor concentracion en comparacion con la necesidad humana se le conoce como aminoacido limitante, a partir del cual se puede calcular una puntuacion quimica de la calidad de la proteina.

Otra forma de medir la calidad de las proteinas es mediante UNP (Utilizacion de Proteinas) que consiste en determinar la cantidad de proteina que realmente se utiliza en el organismo. nitrogeno (gramos) * 6.25 = proteina (gramos). Se compara el nitrogeno de los cadaveres de dos grupos: uno alimentado con una dieta sin proteina y otro con ella. El valor obtenido varia aproximadamente desde 40 hasta 94.

Se debe tener cuidado cuando se utilizan animales en estudios para determinar la cantidad de una proteina para los seres humanos. Por ejemplo, las proteinas de la soja originalmente recibieron una puntuacion baja de UNP cuando se estudiaron en ratas, hasta que se descubrio que la metionina, que es escasa en las proteinas de la soja, es un aminoacido limitante para las ratas. Las ratas necesitan aproximadamente un 50% mas de metiotina que los seres humanos. La OMS y la FDA, adaptaron una puntiacion de aminoacidos corregida por la digestibilidad de la proteina (PAACDP) como metodo oficial para evaluar la calidad de las proteinas en los seres humanos.

Al desnaturalizar las proteinas (mediante calor humedo, marinados con vino o vinagre), mantienen su estructura tridimensional funcional mediante interacciones de hidrogeno e ionicas, los enlaces se debilitan en presencia de acido, sal y calor. Al desnaturalizar las proteinas, estos metodos con frecuencia ablandan los cartilagos y las proteinas del tejido conectivo y liberan las proteinas del musculo de sus uniones, haciendo que todas las proteinas esten mas disponibles para las enzimas digestivas.

Las proteinas vegetales se digieren peor que las animales, en parte porque estan envueltas en paredes celulares de carbohidratos y son menos accesibles para las enzimas digestivas. Algunas plantas tambien contienen enzimas que interfieren con la digestion de las proteinas. Se deben pues desactivar estas enzimas antes de su consumo.

Combinaciones de alimentos que aportan todos los aminoacidos esenciales
|------------------------------+------------------------------------------|
| Combinacion                  | Ejemplos                                 |
|------------------------------+------------------------------------------|
| Cereales y legumbes          | Arroz y alubias                          |
|                              | Sopa de guisantes y pan tostado          |
|                              | Curry de lentejas y arroz                |
|------------------------------+------------------------------------------|
| Cereales y productos lacteos | Pasta y queso                            |
|                              | Arroz con leche                          |
|                              | Sandwich de queso                        |
|------------------------------+------------------------------------------|
| Legumbres y semillas         | Garbanzos y semillas de sesamo;          |
|                              | hummus en forma de salsa, falafel o sopa |
|------------------------------+------------------------------------------|

Otras combinaciones no son complementarias de forma eficaz.

****** Equilibrio nitrogenado

Las regulaciones homeostaticas controlan las concentraciones de los distintos aminoacidos en el organismo y la velocidad a la que se sintetizan e hidrolizan las proteinas musculares y plasmaticas. Cada dia, se destruyen y reconstruyen cantidades similares de proteinas musculares.

El nitrogeno en forma de amoniaco (NH₃) es muy toxico y atraviesa facilmente las membranas, por lo que no se puede permitir que viaje en forma libre por el cuerpo. En situacion posprandial el piruvato y otros esqueletos de carbono captan el nitrogeno (mediante transminacion) y lo transportan hasta el higado en forma de aminoacidos no esenciales, habitualmente alanina y acido glutamico (a partir de α-cetoglutarato). Cuando estos aminoacidos llegan al higado son desaminados o transaminados de nuevo para dar el esqueleto de carbono. Asi, cada molecula de urea que se forma se pueden excretar dos grupos amino que estaban en exceso.

***** Uso y almacenamiento de macronutrientes en situacion posprandial

El aumento de la concentracion de glucosa en la vena porta estimula la secrecion de insulina preformada por el pancreas. Un efecto de la insulina es su efecto sobre los transportadores de glucosa (GLUT4). Sin embargo, el higado es el primer organo que recibe la glucosa de la sangre portal, captando un 50% de la glucosa absorbida mediante transportadores no dependientes de insulina (GLUT2) e inmediatamente fosforiza la glucosa para dar glucosa-6-fosfato utilizando la enzima glucocinasa de elevada capacidad, reteniendo asi la glucosa en celulas hepaticas.

La insulina tambien estimula la oxidacion de la glucosa. Tambien estimula la piruvato deshidrogenasa, que aumenta la glucolisis y la sintesis de acetil CoA en el higado y en el musculo, generando ATP. Si la ingesta de carbohidratos supera la capacidad oxidativa y de almacenamiento, las celulas pueden convertir los carbohidratos en grasas.

El higado recibe grasa de numerosos origenes: residuos de quilomicrones, acidos grasos circulantes, captacion de lipoproteinas intermedias y otras lipoproteinas, y su propia sintesis endogena. El higado reesterifica (volver a formar un ester mediante la union de un acido y un alcohol o fenol) la grasa procedente de todas las fuentes y forma VLDL (lipoproteinas muy ricas en colesterol, pero todavia con demasiados trigliceridos).

Despues de que la LPL haya escindido gran parte de los trigliceridos de las VLDL, el residuo restante se denomina lipoproteina de densidad intermedia (IDL).

***** Catabolismo de los macronutrientes en ayunas

La glucosa es un nutriente obligado para el encefalo y el sistema nervioso, los eritrocitos, los leucocitos y otros tejidos que precisan glucosa. Durante las primeras fases del ayuno se obtiene glucosa a partir del glucogeno por la accion de las hormonas glucagon y adrenalina, aunque estos depositos se vacian en las primeras 24 horas.

En este punto se debe sintetizar de nuevo glucosa utilizando proteinas como sustrato. Las hormonas catabolica adrenalina, tiroxina y glucagon estimulan la liberacion de proteinas musculares y de otros sustratos disponibles para la gluconeogenia. El sustrato aminoacido mas frecuente para la gluconeogenia es la alanina porque, cuando se elimina su nitrogeno, la alanina se transforma en piruvato. Nunca habra una deplecion total de glucogeno, incluso durante inanicion prolongada, se mantiene cuidadosamente una pequena cantidad de glucogeno preformado como cebador de la nueva sintesis de glucogeno.

En ayuno prolongado, la gluconeogenia hepatica disminuye de sintetizar el 90% de glucosa a menos del 50%, el resto es suministrado por el rinon. El musculo puede liberar piruvato y lactato para la gluconeogenia en un proceso denominado ciclo de Cori: los musculos liberan tambien glutamina y alanina. Estos aminoacidos se pueden desaminar o transaminar para dar α-cetoglutarato o piruvato respectivamente, y se pueden convertir en oxalacetato y despues en glucosa. Durante el ayuno prolongado el rinon necesita amoniaco para excretar los productos metabolicos acidos. Se utiliza con este fin la glutamina derivada del musculo, y la glutamina desaminada (α-cetoglutarato) se puede utilizar para sintetizar glucosa. Por tanto, durante la inanicion aumenta la sintesis de glucosa por el rinon y disminuye su sintesis por el higado.

Ademas de la glucosa, durante el ayuno es necesaria una fuente de energia fiable, y la mejor para ello es la grasa almacenada en los adipocitos y es utilizada principalmente por los musculos para sintetizar ATP. La liberacion y utilizacion de los acidos grasos precisan concentraciones bajas de insulina y un aumento de las hormonas antiinsulinicas glucagon, cortisona, adrenalina y hormona de crecimiento. Las hormonas antiinsulinicas activan la enzima lipasa sensible a hormonas de la membrana del adipocito. Esta enzima hidroliza los trigliceridos almacenados, liberando acidos grasos y glicerol desde las celulas grasas. Los acidos viajan hasta el higado unidos a la albumina serica y entran facilmente en las celulas hepaticas. Una vez dentro de la celula, los acidos grasos entran en las mitocondrias hepaticas mediante el sistema transportador de la carnitina aciltransferasa, que transporta esteres de acidos grasos y carnitina a traves de la membrana mitocondrial. Dentro de la mitocrondria se formara acetil CoA a partir de acido graso CoA mediante el proceso de β-oxidacion. Durante la inanicion se acumula un exceso de moleculas de acetil CoA en el higado, porque el higado puede obtener toda la energia necesaria del proceso de β-oxidacion y formar cetonas, que despues entran en el torrente sanguineo y pueden actuar como fuente de energia para los musculos, ahorrando de esta forma proteinas.

La adaptacion a la inanicion depende de la sintesis de cetonas. A medida que aumenta la concentracion sanguinea de cetonas en el ayuno, el encefalo y el sistema nervioso, aunque son consumidores obligados de glucosa, comienzan a utilizar cetonas como fuente de energia. Como el encefalo utiliza un combustible diferente a la glucosa, disminuye la demanda de proteinas musculares para la gluconeogenia, lo que reduce la velocidad del catabolismo muscular. La reduccion del catabolismo muscular reduce la cantidad de amoniaco que recibe el higado. La sintesis hepatica de urea disminuye de manera marcada, lo que refleja la menor velocidad de desaminacion de las proteinas musculares. Si el ayuno se prolonga durante varias semanas se minimiza la velocidad de sintesis y excrecion de urea.

Una persona que se ha adaptado a la inanicion se minimizan las perdidas proteicas y se conserva la masa magra. Aunque la grasa no se puede convertir en glucosa, si proporciona combustible para el musculo y el encefalo en forma de cetonas. Mientras se disponga de agua, una persona normal puede ayunar un mes. Cuando se agotan los depositos de grasa se utilizan proteinas, y la muerte es la consecuencia ultima.

**** Micronutrientes

Las vitaminas se definen como micronutrientes esenciales que satisfacen:
 1. Compuestos organicos diferente a las grasas, carbohidratos y proteinas.
 2. Componentes naturales de los alimentos, presentes habitualmente en cantidades muy pequenas
 3. No sintetizados por el cuerpo en cantidades suficientes para satisfacer las necesidades fisiologicas normales
 4. Esenciales para una funcion fisiologica normal.
 5. Su ausencia o insuficiencia produce un sindrome especifico.

Los vitameros son isomeros o analogos activos de las vitaminas, y existen 4 categorias:
 1. Estabilizadores de membrana.
 2. Donantes y aceptadores de atomos de hidrogeno (H⁺) y electrones.
 3. Hormonas.
 4. Coenzimas.

Las vitaminas liposolubles se excretan generalmente por las heces mediante circulacion hepatica, mientras que las vitaminas hidrosolubles o sus metabolitos se excretan por la orina.
